<?php
    ...
    WHERE `TEN_TRUONG` LIKE '%$school%'  AND (`truong`.`MA_LOAI` = 'L02' OR `truong`.`MA_LOAI` = 'L03') ORDER BY `NAM_HOC` DESC;
    EOD;
    ...
    <?php
        ...
        <div id="ratioFigure">
            <h3 style="color:red; text-align:center;">*Kết quả không khớp*</h3>
        </div>
    <?php
    }?>
